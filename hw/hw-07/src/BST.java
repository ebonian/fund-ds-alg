...
public class BST {
	...
	public void addLeftSubTreeToMin(BST subtree) {
		...
		TreeIterator thisMin = (TreeIterator) this.findMin();
		TreeIterator subtreeMax = (TreeIterator) subtree.findMax();
		
		if (subtreeMax.currentNode.data > thisMin.currentNode.data) {
			return;
		}
		
		thisMin.currentNode.left = subtree.root;
		subtree.root.parent = thisMin.currentNode;
